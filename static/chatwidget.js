...
(function() {
    ...
    // Live chat keywords for agent transfer detection  
    const liveChatKeywords = [
        'live chat', 'talk to agent', 'human agent', 'real person', 
        'customer service', 'speak to someone', 'chat with agent',
        'connect me to agent', 'transfer to agent', 'live support'
    ];
